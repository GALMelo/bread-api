...
var StockCategoryService = /** @class */ (function () {
    ...
    StockCategoryService.prototype.create = function (createStockCategoryDto) {
        return __awaiter(this, void 0, void 0, function () {
            var newStockCategory, saveStockCategory;
            return __generator(this, function (_a) {
                try {
                    newStockCategory = (0, typeorm_1.getRepository)(stock_category_entity_1.StockCategory).create();
                    newStockCategory.name = createStockCategoryDto.name;
                    saveStockCategory = (0, typeorm_1.getRepository)(stock_category_entity_1.StockCategory).save(newStockCategory);
                    return [2 /*return*/, saveStockCategory];
                }
                catch (error) {
    ...
    StockCategoryService.prototype.findAll = function () {
        try {
            return (0, typeorm_1.getRepository)(stock_category_entity_1.StockCategory).find();
        }
        catch (error) {
            throw new common_1.HttpException({
                status: common_1.HttpStatus.BAD_REQUEST,
    ...
    StockCategoryService.prototype.update = function (id, updateStockCategoryDto) {
        try {
            return (0, typeorm_1.getRepository)(stock_category_entity_1.StockCategory).update(id, updateStockCategoryDto);
        }
        catch (error) {
            throw new common_1.HttpException({
                status: common_1.HttpStatus.BAD_REQUEST,
    ...
    StockCategoryService.prototype.remove = function (id) {
        try {
            return (0, typeorm_1.getRepository)(stock_category_entity_1.StockCategory).delete(id);
        }
        catch (error) {
            throw new common_1.HttpException({
                status: common_1.HttpStatus.BAD_REQUEST,
